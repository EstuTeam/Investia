...
// Load signing credentials from local.properties (not in version control)
...
dependencies {
    ...
    // Compose BOM - align all compose dependency versions
    ...
    // Serialization (Gson only - kotlinx-serialization removed as unused)
