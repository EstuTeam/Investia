...
import com.midastrading.app.BuildConfig
...
object NetworkModule {
    ...
    /**
     * Retry interceptor with coroutine-friendly delay.
    ...
    fun provideRetryInterceptor(): Interceptor {
        return Interceptor { chain ->
            ...
            while ((response == null || response.code in listOf(502, 503, 504))
            ...
            response ?: throw IOException("Bağlantı kurulamadı")
        }
    }
    ...
    @Provides
    @Singleton
    fun provideMidasApiService(retrofit: Retrofit): MidasApiService {
